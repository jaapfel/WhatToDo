 ...
 */
public class from2to3hours  extends ActionBarActivity {
    ListView listView ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] choices = {"Go for a hike", "Work on the Rubix Cube", "Go to the relaxing movie theatre", "Go to a play",
                "Go to the drive-ins", "Scavenger Hunt", "Play a game", "Play the Geocaching game"};
