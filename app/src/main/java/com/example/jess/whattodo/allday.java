 ...
 */
public class allday  extends ActionBarActivity {
    ListView listView ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] choices = {"Go to the snow", "Go to the Children's Museum", "Go to the PinBall Museum",
                "Go to Tech Museum", "Go to Yosemite", "Go to Six FLags", "Go to the Exploratorium",
                "Go to the beach"};
